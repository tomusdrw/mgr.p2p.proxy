"""
Python script to generate the pyrope logo. 
Outputs svg data on stdout.

Copyright 2009 Nicolas Dumazet <nicdumz@gmail.com>

Adapted from http://commons.wikimedia.org/wiki/File:Ageev_5X_circle_graph.svg by
David Eppstein, released by author to Public Domain.
...
svgStyle('fill="none" stroke="teal"')
